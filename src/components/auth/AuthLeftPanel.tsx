  ...
  return (
    <div className="flex flex-col justify-between h-full">
      ...
      <div className="space-y-8">
        ...
        <span className="inline-block text-xs font-semibold text-primary bg-primary-light border border-primary-light/40 px-3 py-1 rounded-full">
        ...
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
          ...
          <div className="bg-slate-50 border-b border-slate-200 px-4 py-3 flex items-center justify-between">
            ...
            <span className="text-[10px] font-semibold text-primary bg-primary-light border border-primary-light/40 px-2 py-0.5 rounded-full">
              Live
            </span>
          </div>
        ...
        <ul className="space-y-2.5">
          {bullets.map((b) => (
            <li key={b} className="flex items-center gap-2.5 text-sm text-slate-600">
              <span className="w-5 h-5 rounded-full bg-primary-light border border-primary-light/40 flex items-center justify-center shrink-0">
